...
// var_dump($staff);die();
    ...
    public function getStaffReceivers($id = '', $active = '', $where = array())
    {
    ...
    public function add($data)
    {
        ...
        // Custom permissions
        if (isset($data['custompermission'])) {
            foreach($data['custompermission'] as $key=>$value) {
                $permissions[$key] = $value;
            }
            unset($data['custompermission']);
        }
