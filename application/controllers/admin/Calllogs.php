...
//        }
    ...
    public function information_phone_client()
    {
        $phone=$this->input->post('phone');
        $data=$this->call_logs_model->get_clients_phone($phone,'tblclients');
        echo json_encode($data);
    }
    public function information_phone_leads()
    {
        $phone=$this->input->post('phone');
        $data=$this->call_logs_model->get_clients_phone($phone,'tblleads');
        echo json_encode($data);
    }
