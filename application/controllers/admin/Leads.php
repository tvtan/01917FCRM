...
// callcenter
    ...
    {
       $strChannel = $_POST['exten'];
$number=strtolower($_POST['tel']);

$strCom = 'curl -i -H "Accept: application/json" -H "Content-Type: application/json" -H "Authorization: Bearer uLUr2K8vOp2FV73xdS0YWkMq8GhM92Jq" -X POST  -d \'{"from_num": "'.$strChannel.'", "to_num": "'.$number.'", "answer_url": "http://tel4vn.com"}\'   http://api.tel4vn.com:8080/api/v1/autocall/accounte6e9ffd9f92cc20912a54c4b671857e7/call';
//echo $strCom; exit();
exec($strCom,$arrStatus,$return_var);
