      ...
      <div class="col-md-5 left-column">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <?php echo render_select3('client',$customersCBO,array('userid','company','phonenumber,mobilephone_number,subtext'),'contract_client_string',$selected,array(),array(),'',$auto_toggle_class); ?>
            ...
            <div class="form-group">
              ...
              <div class="input-group" data-toggle="tooltip" title="<?php echo _l('contract_value_tooltip'); ?>">
                <input type="text" class="form-control" name="contract_value" onkeyup="formatNumBerKeyUp(this)" value="<?php if(isset($contract)){echo number_format($contract->contract_value); }?>">
