...
<?php $value = (isset($member) ? $member->staff_code : 'NV'.$maxid); ?>
...
<div class="form-group">
 ...
 <div class="checkbox checkbox-primary">
  ...
  ?>
  <input type="radio" id="dep_<?php echo $department['departmentid']; ?>" name="departments[]" value="<?php echo $department['departmentid']; ?>"<?php echo $checked; ?>>
...
<?php $value = (isset($member) ? $member->rule : ''); ?>
    <div class="col-md-12">
        <input type="radio" name="rule" value="1" <?php if($value=='1') echo "checked"; ?>>
        <label for="administrator"><?php echo _l('rule_super_admin'); ?></label>
        <input type="radio" name="rule" value="2" <?php if($value=='2') echo "checked"; ?>>
        <label for="administrator"><?php echo _l('rule_admin'); ?></label>
        <input type="radio" name="rule" value="3" <?php if($value=='3') echo "checked"; ?>>
        <label for="administrator"><?php echo _l('rule_staff'); ?></label>
        <input type="radio" name="rule" value="4" <?php if($value=='4') echo "checked"; ?>>
