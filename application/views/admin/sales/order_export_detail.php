                                ...
                                <div role="tabpanel" class="tab-pane active" id="money_goods">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            if($arr) 
                                                {
                                                    $warehouse_id=get_option('default_PSO_warehouse');
                                        ...
                                        <table class="table items item-purchase no-mtop">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="sortable item">
                                                    ...
                                                    ?>
                                                    <td><input style="width: 100px;<?=$type?>" class="mainQuantity <?=$class?>"  <?=$strmax?>  type="number" name="items[<?php echo $i; ?>][quantity]" value="<?php echo $max; ?>" <?='data-store="'.$data_store.'"'?> <?=$title?> <?=$item->rel_id?'readonly':''?>><?=$strexport?></td>
                                                    ...
                                                    $exists_refer=total_rows('tblsales',array('rel_id'=>$item->id));
                                                    ...
                                                    if($exists_refer)
                                                    {
                                                        $adjustment=$transport_fee=$installation_fee=0;
                                                    }
