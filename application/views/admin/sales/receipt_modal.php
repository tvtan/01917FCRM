                            ...
                            <table class="table items item-export no-mtop">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left"><?php echo _l('total_money_deposit'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="sortable item">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input <?=$readonly?> type="text"  name="items[<?php echo $i ?>][subtotal]" class="form-control _subtotal" onkeyup="formatNumBerKeyUp(this)" value="<?=number_format($get_sales->total-getTotalMoneyReceiveFromCustomer($sale_id,'PO'))?>">
                                            </div>
                                        </td>
                                        <td <?=$style?>>
                                    ...
                                    <?php } else{ ?>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input <?=$readonly?> type="text" name="item[<?php echo $i ?>][subtotal]" class="form-control _subtotal" onkeyup="formatNumBerKeyUp(this)" value="<?=number_format($receipt->subtotal)?>">
                                            </div>
                                        </td>
                                        <td <?=$style?>>
