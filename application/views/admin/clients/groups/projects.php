...
<a href="<?php echo admin_url('sale_orders/sale_detail/?customer_id='.$client->userid); ?>"  class="btn btn-info mbot25<?php if($client->active == 0){echo ' disabled';} ?>"><?php echo _l('new_project'); ?></a>
<?php }
$table_data = array(
  '#',
  _l('project_name'),
