            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        echo render_select('contact_title', $client_title_value, array('id', 'name'), 'Danh xưng', (isset($client) ? $contact->contact_title : ''), array(), array(), '', '', true);
                        ?>
                        ...
                        <?php echo render_input( 'lastname', 'client_fullname',$value); ?>
                    ...
                    <div class="client_password_set_wrapper" style="display: none;">
                        <label for="password" class="control-label">
                            <?php echo _l( 'client_password'); ?>
                        </label>
                        <div class="input-group">
                            <input type="password" class="form-control password" name="password" value="12345678" autocomplete="off">
