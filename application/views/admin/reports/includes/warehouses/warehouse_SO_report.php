    <div id="warehouse-SO-report" class="hide">
      <div class="row">
         <div class="clearfix"></div>
        
         <div class='col-md-4'>
            <?php echo render_select('warehouse_invenroty_SO',$warehouses,array('warehouseid','warehouse'),'Kho',array(),array('multiple'=>true)) ?>
         </div>
         <div class='col-md-4'>
            <?php echo render_select('product_category_SO', $categories, array('id', 'category'), 'Danh mục cha'); ?>
         </div>
      ...
      <table class="table table table-striped table-warehouse-SO-report">
         <thead>
            <tr>
