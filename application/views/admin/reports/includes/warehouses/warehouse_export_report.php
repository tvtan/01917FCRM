    <div id="warehouse-export-report" class="hide">
      <div class="row">
         <div class="clearfix"></div>
         
         <div class='col-md-4'>
            <?php echo render_select('warehouse_invenroty_export',$warehouses,array('warehouseid','warehouse'),'Kho',array(),array('multiple'=>true)) ?>
         </div>
         <div class='col-md-4'>
            <?php echo render_select('product_category_export', $categories, array('id', 'category'), 'Danh mục cha'); ?>
         </div>
      ...
      <table class="table table table-striped table-warehouse-export-report">
         <thead>
            <tr>
               ...
               <th rowspan="2" class="text-center"><?php echo _l('warehouse_from'); ?></th>
