    ...
    <div class="row">
        <div class="lead-view<?php if(!isset($lead)){echo ' hide';} ?>">
            <div class="col-md-4 col-xs-12 mtop15">
                ...
                <p class="text-muted lead-field-heading no-mtop"><?php echo _l('lead_add_company'); ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->name != '' ? $lead->name : '-') ?></p>
                <p class="text-muted lead-field-heading no-mtop "><?php echo _l('lead_add_code'); ?></p>
                ...
                <p class="text-muted lead-field-heading"><?php echo _l('load_add_career'); ?></p>
                ...
                <p class="text-muted lead-field-heading"><?php echo _l('load_add_business_owners'); ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->company != '' ? $lead->company : '-') ?></p>
                <p class="text-muted lead-field-heading"><?php echo _l('lead_address_in'); ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->address != '' ? $lead->address : '-') ?></p>

                <p class="text-muted lead-field-heading"><?php echo _l('load_add_number_cndkdn'); ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->code_number != '' ? $lead->code_number : '-') ?></p>
                <p class="text-muted lead-field-heading"><?php echo _l('load_add_date_range'); ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->date_register != '' ? $lead->date_register : '-') ?></p>


                <p class="text-muted lead-field-heading"><?php echo _l('load_add_address_range'); ?></p>
                ...
                <p class="text-muted lead-field-heading"><?php echo _l('load_add_tax_code'); ?></p>
        ...
        <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
            ...
            <div class="col-md-6">
                ...
                <?php $value = (isset($lead) ? $lead->title : ''); ?>
                <?php echo render_input('title','lead_add_code',$value); ?>

                <?php $value = (isset($lead) ? $lead->name : ''); ?>
                <?php echo render_input('name','lead_add_company',$value); ?>
                <?php $value = (isset($lead) ? $lead->email : ''); ?>
                <?php echo render_input('email','lead_add_edit_email',$value); ?>
                <?php $value = (isset($lead) ? $lead->website : ''); ?>
                <?php echo render_input('website','load_add_career',$value); ?><!--Ngành nghề kinh doanh-->
                <?php $value = (isset($lead) ? $lead->phonenumber : ''); ?>
                <?php echo render_input('phonenumber','lead_add_edit_phonenumber',$value); ?><!-- số điện thoại-->
                <?php $value = (isset($lead) ? $lead->company : ''); ?>
                <?php echo render_input('company','load_add_business_owners',$value); ?><!-- chủ doanh nghiệp-->
            </div>
            <div class="col-md-6">
                <?php $value = (isset($lead) ? $lead->address : ''); ?>
                <?php echo render_input('address','lead_address_in',$value); ?><!-- trụ sở chính-->

                <?php $value = (isset($lead) ? $lead->code_number : ''); ?>
                <?php echo render_input('code_number','load_add_number_cndkdn',$value); ?><!--Số CNĐKDN-->
                <?php $value = (isset($lead) ? $lead->date_register : ''); ?>
                <!--        --><?php //echo render_input('date_register','load_add_date_range',$value); ?><!--<!--Ngày cấp-->
                <?php echo  render_datetime_input('date_register','load_add_date_range',$lead->date_register,array('data-date-end-date'=>date('Y-m-d')));?>
                <?php $value = (isset($lead) ? $lead->city : ''); ?>
                <?php echo render_input('city','load_add_address_range',$value); ?><!--Nơi cấp-->
                <?php $value = (isset($lead) ? $lead->zip : ''); ?>
                <?php echo render_input('zip','load_add_tax_code',$value); ?><!--Mã số thuế (Tương tự - khác)-->
