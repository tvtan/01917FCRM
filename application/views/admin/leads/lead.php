   ...
   <div class="top-lead-menu">
      <ul class="nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
         ...
         <?php if(isset($lead)){ ?>
            ...
            <li role="presentation">
            <li role="presentation">
               <a href="#tab_call_logs" onclick="initDataTable('.table-call-logs', admin_url + 'calllogs/init_relation_logs/' + <?php echo $lead->id; ?> + '/' + 'lead', [4], [4]);" aria-controls="tab_call_logs" role="tab" data-toggle="tab">
                  <?php echo _l('lead_call_logs'); ?>
               </a>
               <!--<!--      </li>-->
               <!--<!--         <a href="#tab_call_logs" onclick="init_rel_call_logs_table(--><?php ////echo $lead->id; ?><!--//,'lead','.table-rel-call_logs');" aria-controls="tab_call_logs" role="tab" data-toggle="tab">-->
               <!--//            --><?php ////echo _l('lead_call_logs'); ?>
               <!--<!--         </a>-->
               <!--<!--      </li>-->
            <li role="presentation">
