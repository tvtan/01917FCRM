<div class="col-md-12">
 <div class="panel_s">
  <div class="panel-body _buttons">
   ...
   <a href="<?php echo admin_url('invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list"><?php echo _l('Tạo kế hoạch'); ?></a>
   <?php } ?>
   <!-- <div class="display-block text-right">
    <div class="btn-group pull-right mleft4 invoice-view-buttons btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('filter_by'); ?>">
     ...
     <li class="active">
       <a href="#" data-cview="year_<?php echo $year['year']; ?>" onclick="dt_custom_view(<?php echo $year['year']; ?>,'.table-invoices','year_<?php echo $year['year']; ?>'); init_invoices_total(true); return false;"><?php echo $year['year']; ?>
       </a>
     </li>
     <?php } ?>
     <?php } ?>
     ...
     <li class="dropdown-submenu pull-left">
       ...
       <ul class="dropdown-menu dropdown-menu-left">
        ...
        <li>
         <a href="#" data-cview="sale_agent_<?php echo $agent['sale_agent']; ?>" onclick="dt_custom_view(<?php echo $agent['sale_agent']; ?>,'.table-invoices','sale_agent_<?php echo $agent['sale_agent']; ?>'); init_invoices_total(true); return false;"><?php echo get_staff_full_name($agent['sale_agent']); ?>
         </a>
       </li>
       <?php } ?>
     </ul>
   ...
   <?php foreach($payment_modes as $mode){
     ...
     ?>
     <li>
       <a href="#" data-cview="invoice_payments_by_<?php echo $mode['id']; ?>" onclick="dt_custom_view('<?php echo $mode['id']; ?>','.table-invoices','invoice_payments_by_<?php echo $mode['id']; ?>'); init_invoices_total(true); return false;">
   ...
   <div class="panel_s">
    <div class="panel-body">
     ...
     $table_data = array(
      ...
      _l('Lý do'),
      _l('Trạng thái'));
     $custom_fields = get_custom_fields('purchase_plans',array('show_on_table'=>1));
...
<script type="text/javascript">
  if ($('.table-purchases').length > 0) {
        ...
        // Invoices tables
        _table_api = initDataTable('.table-purchases', admin_url + 'invoices/list_invoices', 'undefined', 'undefined', Invoices_Estimates_ServerParams, [
            [3, 'DESC'],
            [0, 'DESC']
        ]);
