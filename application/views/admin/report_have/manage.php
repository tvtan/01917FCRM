...
//    });
    ...
    initDataTableFixedHeader('.table-report_haves', window.location.href, [0], [0], filterList, [5,'DESC']);
...
<style type="text/css">
  .table-report_haves tr td:nth-child(7){
    max-width: 200px;
    white-space: inherit;
    min-width: 200px;
  }
  .table-report_haves tr td:nth-child(3){
    max-width: 200px;
    white-space: inherit;
    min-width: 200px;
  }
  .table-report_haves tr td:nth-child(2){
    max-width: 200px;
    white-space: inherit;
    min-width: 200px;
  }
