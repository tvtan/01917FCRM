            ...
            <?php echo form_open_multipart(admin_url('exports/export_detail'), array('class' => 'sales-form', 'autocomplete' => 'off')); ?>
                <div class="row">
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">            
                    ...
                    echo render_select3('customer_id',$customers,array('userid','company','phonenumber,mobilephone_number,subtext'),'client',$selected);
                    ?>
                            ...
                            <table class="table items item-export no-mtop">
                                ...
                                <tbody>
                                    ...
                                    <tr class="sortable item">
                                        ...
                                        <input style="width: 100px; <?=$style?>" min="1" max="<?=$value->quantity-$value->export_quantity?>" class="mainQuantity <?=$err?>" type="number" name="items[<?php echo $i; ?>][quantity_net]" value="<?=($value->quantity==$value->export_quantity)? 0 : $value->quantity-$value->export_quantity ?>">
                                        <?php                                         
                                        ...
                                        <?php
                                            $totalQuantity+=$value->quantity-$value->export_quantity;
                                            $i++;
                                        }
                                    }
