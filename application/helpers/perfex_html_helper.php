...
function render_select3($name, $options, $option_attrs = array(), $label = '', $selected = '', $select_attrs = array(), $form_group_attr = array(), $form_group_class = '', $select_class = '', $include_blank = true)
{
    ...
    foreach ($options as $option) {
        ...
        if (isset($option_attrs[2])) {
            ...
            if (strpos($option_attrs[2], ',') !== false) {
                ...
                $_temp    = explode(',', $option_attrs[2]);
                foreach ($_temp as $t) {
                    if (isset($option[$t]) && !empty($option[$t])) {
                        $sub_text .= '['.$option[$t] . '] ';
                    }
...
function format_status_adjustment($id,$type='adjustment')
{
        ...
        if ($id == 2) {
            ...
            {   
                ...
                $status_name=str_replace('Phiếu điều chỉnh', $replace, $status_name);
            }
